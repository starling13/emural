...
struct qt_meta_stringdata_LampArray_t {
    QByteArrayData data[1];
    char stringdata[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_LampArray_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_LampArray_t qt_meta_stringdata_LampArray = {
    {
...
const QMetaObject LampArray::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LampArray.data,
      qt_meta_data_LampArray,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LampArray.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_DisplayPanel_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject DisplayPanel::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_DisplayPanel.data,
      qt_meta_data_DisplayPanel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DisplayPanel.stringdata))
