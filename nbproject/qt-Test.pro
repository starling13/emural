...
FORMS += "Исходные тексты/AdderRegisterPanel.ui" "Исходные тексты/ArithmUnitRegisterPanel.ui" "Исходные тексты/CommandRegisterPanel.ui" "Исходные тексты/ControlRegisterPanel.ui" "Исходные тексты/PCWIdget.ui"
