...
FORMS += "Исходные тексты/AdderRegisterPanel.ui" "Исходные тексты/ArithmUnitRegisterPanel.ui" "Исходные тексты/CommandDecoderWidget.ui" "Исходные тексты/CommandRegisterPanel.ui" "Исходные тексты/PCWIdget.ui"
