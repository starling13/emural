...
PKGCONFIG +=
QT = core gui widgets
SOURCES += "Исходные тексты/DrumWidget.cpp" "Исходные тексты/PanelWidget.cpp" "Исходные тексты/PowerPultWidget.cpp" "Исходные тексты/PultWIdget.cpp" "Исходные тексты/controlregisterpanel.cpp" "Исходные тексты/controls.cpp" "Исходные тексты/intdelegate.cpp" "Исходные тексты/main.cpp" "Исходные тексты/test.cpp" "Исходные тексты/ural.cpp"
