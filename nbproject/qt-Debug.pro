...
FORMS += "Исходные тексты/AdderRegisterPanel.ui" "Исходные тексты/ArithmUnitRegisterPanel.ui" "Исходные тексты/AuxControlsWidget.ui" "Исходные тексты/ControlRegisterPanel.ui" "Исходные тексты/DrumWidget.ui" "Исходные тексты/PCWIdget.ui" "Исходные тексты/PanelWidget.ui" "Исходные тексты/PultWIdget.ui"
